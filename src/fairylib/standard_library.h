...
{
	stringId a = pRuntime->pop_and_deref_object_from_stack()->toStringId(pRuntime);
...
{
	FairyObject* pObj = pRuntime->pop_and_deref_object_from_stack();
...
{
	objectId argId = pRuntime->soft_pop_from_stack();
