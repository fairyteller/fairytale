...
Runtime::Runtime(FairytaleCore* pCore)
	: m_core(pCore)
{
	register_function("pow", pow_wrapper);
	register_function("+", sum_wrapper);
	register_function("-", wrap<long long, long long, long long, sub>());
	register_function("*", wrap<long long, long long, long long, mul > ());
	register_function("/", wrap<long long, long long, long long, __div__>());
	register_function("%", wrap<long long, long long, long long, __mod__>());
	register_function("+=", sum_compound);
	register_function("-=", sub_compound);
	register_function("*=", mul_compound);
	register_function("/=", div_compound);
	register_function("%=", mod_compound);
	register_function("==", __is_eq__);
	register_function("!=", __is_neq__);
	register_function("<", __less_than__);
	...
	register_function("trace_names", ::trace_names);
	register_function("print_stack", print_stack);
	register_function("input", input_wrapper);
	register_function("int", int_wrapper);
	register_function("str", str_wrapper);
	register_function("bool", bool_wrapper);
	register_function("import_module", ::import_module);
	register_function("getattr", getattr);
	register_function("setattr", setattr);
